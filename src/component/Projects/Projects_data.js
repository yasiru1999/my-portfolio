const Projects_data = [
    {
        ...
        desc:"A Railway train ticket reservation system developed using java servlet with MVC architecture for the software engineering  2nd year OOP module in SLIIT." +
            " The system's main functionalities are users can make train ticket reservations,  check train timetables, make reservations for transport gods on the train, and Search for train details. ",
    },
    {
        id: 2,
        ...
        desc:"Research-Project-Management-Tool is develop for the SLIIT university 4th year students." +
            " From This system, Student can request supervisors/Co-supervisors for their research group. " +
            "Lectures can see progress and other related things for assign research group ." +
            "This Project build with react for frontend and nodeJS for the backend." +
            "For this project we use MongoDB as our database.",
    },
    {
        id: 3,
    ...
    },
    {
        ...
        desc:"A Movie ticket reservation system developed using ReactJs as the frontend and NodeJs as the backend for the software engineering 3rd year Distributed system module in SLIIT." +
            " System services integrate with the Wso2 Service integrator. This system's main functionalities are users can make movie ticket reservations, check theaters' timetables, Get tickets as QR codes, and Search for movie details.",
    },
]
